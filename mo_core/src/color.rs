...
impl std::ops::Mul<f32> for FColor {
    type Output = Self;
...
impl From<FColor> for [f32; 4] {
    fn from(rgba: FColor) -> Self {
        [rgba.r, rgba.g, rgba.b, rgba.a]
    }
}

impl From<FColor> for [f32; 3] {
