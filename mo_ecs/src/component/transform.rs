...
use bevy_math::{Dir3, Mat3, Mat4, Quat, Vec3};
use core::ops::Mul;

/// 描述了实体的位置信息。如果实体有父实体，那么它的位置是相对于其父实体的位置。
...
impl Transform {
    ...
    /// Returns the 3d affine transformation matrix from this transforms translation, rotation, without scale.
    #[inline]
    pub fn model_matrix_without_scale(&self) -> Mat4 {
    ...
    /// # use mo_ecs::component::Transform;
